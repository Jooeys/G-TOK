...
/**
 * generates the proof offchain using the  Know-Your-Device(KYD) information of the user and associated it with the other parameter details.
 * 
 */
...
const sensorIdentifiedInfo = ["0x00000a86986129038908a9808098-waterSensor1-pH-7-Station1-Va-de-Marne-France", "0x00000a86986129038908a9808098-waterSensor2-pH-7-Station1-Va-de-Marne-France"].map(x => keccak256(x));
...
const leaf = keccak256('0x00000a86986129038908a9808098-waterSensor1-pH-7-Station1-Va-de-Marne-France')
