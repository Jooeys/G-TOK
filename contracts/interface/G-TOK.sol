...
interface G-TOK{
    ...
    */
    ...
    /// @param claimer is the EOA address that wants to validate the SBT issued to it by the KYD. 
    ...
    */
    ...
    /// @return the struct array of all the descriptions of condition metadata that is defined by the administrator for the given KYD provider.
    /**
    ex: standardClaim(1) --> {
    { "title":"temperature",
        "kind": "uint",
        "description": "temperature of the sensor installed in the permited area",
        },
       "logic": ">=",
    "value":"20℃"  
    }
    ...
    **/
    ...
    example: {
        "WaterSensor": [
            ...
            {
            "field": "hexagon address",
            "values": [
                {"value": "871fb4651ffffff"}
            ]
            }
        ]
        }
    ...
    */
    ...
    // eg: revoke(0xfoo,1): means that KYD admin revokes the SBT certificate number 1 for the address '0xfoo'.
